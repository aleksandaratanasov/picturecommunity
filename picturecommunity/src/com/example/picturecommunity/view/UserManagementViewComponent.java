...
public class UserManagementViewComponent extends Panel {
	...
	public UserManagementViewComponent() {		
		...
		/*table.addItem(new Object[] { true, 10L, "x1" }, 1);
		table.addItem(new Object[] { true, 10L, "x2" }, 2);
		table.addItem(new Object[] { true, 10L, "x3" }, 3);
		table.addItem(new Object[] { true, 10L, "x4" }, 4);*/
